...
set :repository,  "git@github.com:danielshore/analyse.git"
set :scm, "git"
set :scm_passphrase, "footba1l" #This is your custom users password
set :user, "danielshore"
set :branch, "master"
...
#set :repository, "github.com/danielshore/analyse.git"

# NOTE: for some reason Capistrano requires you to have both the public and
# the private key in the same folder, the public key should have the 
# extension ".pub".
ssh_options[:keys] = ["#{ENV['HOME']}/.ec2/key.prv"]

# Your EC2 instances. Use the ec2-xxx....amazonaws.com hostname, not
# any other name (in case you have your own DNS alias) or it won't
# be able to resolve to the internal IP address.
role :web,      "ec2-174-129-105-231.compute-1.amazonaws.com"
role :app,      "ec2-174-129-105-231.compute-1.amazonaws.com"
#role :db,       "ec2-56-xx-xx-xx.z-1.compute-1.amazonaws.com", :primary => true
role :memcache, "ec2-174-129-105-231.compute-1.amazonaws.com"
...
set :ec2onrails_config, {
  ...
  # remove this.
  :admin_mail_forward_address => "danielshore@gmail.com",
